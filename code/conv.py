...
class GNN_node(torch.nn.Module):
    ...
    def forward(self, batched_data):
        ...
        # Different implementations of JK-concat(Jumping Knowledge)
        if self.JK == "last":
        ...
        return node_representation  # 返回的是多层GNN最终得到的node embedding
